...
using BulkyWeb.Areas.Identity.Models.Account;
using BulkyWeb.Areas.Identity.Models.AccountViewModels;
using BulkyWeb.ExtendMethods;
...
namespace BulkyWeb.Areas.Identity.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> SendCode(SendCodeViewModel model)
        {
            ...
            {
                ModelState.AddModelError("", "Provider is required.");
                return View(model);
            }

            // Nếu dùng Authenticator thì chuyển hướng đến VerifyAuthenticatorCode
            ...
            else if (model.SelectedProvider == "Phone")
            {
                ...
                {
                    await _emailSender.SendSmsAsync(phone, message);
                }
            }
