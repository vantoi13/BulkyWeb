...
namespace BulkyWeb.Data
{
    public class DbInitializer
    {
        ...
        {
            // Seed Roles
            var roleNames = typeof(RoleName).GetFields().Select(r => (string)r.GetRawConstantValue()!).ToList();
            ...
            if (userAdmin == null)
            {
                ...
                await _userManager.AddToRolesAsync(userAdmin, new List<string> { RoleName.Administrator });
